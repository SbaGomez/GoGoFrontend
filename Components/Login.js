  ...
  return (
    <Stack fill center spacing={4}>
      ...
      >
        ...
        <TextInput label="Contraseña" mode="outlined" placeholder="Contraseña" maxLength={15} secureTextEntry right={<TextInput.Affix text="/15" />} style={{ width: '80%', maxWidth: "60%", minWidth: "30%", height: 50, marginBottom: 50, display: 'flex', justifyContent: 'center' }} />

        <Button title="Ingresar" style={{ backgroundColor: '#24CAE8', width: '80%', textAlign: 'center', maxWidth: "60%", minWidth: "30%", height: 50, marginBottom: 15, display: 'flex', justifyContent: 'center' }} />
